...
class Solution {
    public int[] successfulPairs(int[] spells, int[] potions, long success) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            // Binary search to find the first potion with strength >= success / spellStrength
            ...
            // If no suitable potion found, continue to the next spell
            if (index == -1) {
                continue;
            }

            // Calculate the number of successful pairs for the current spell
            successfulPairs[i] = m - index;
        }
