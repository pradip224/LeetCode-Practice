...
class Solution {
    public int distanceBetweenBusStops(int[] distance, int start, int destination) {
        ...
        while (currentStop != destination) {
            clockwiseDistance += distance[currentStop];
            currentStop = (currentStop + 1) % n;
        }
        
        // Step 3: Calculate counterclockwise distance from start to destination
        int counterclockwiseDistance = totalDistance - clockwiseDistance;
        
        // Step 4: Return the minimum of clockwise and counterclockwise distances
